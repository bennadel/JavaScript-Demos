...
var CompilerHost = (function () {
    function CompilerHost(options, builder) {
        ...
        if ((this._options.target !== ScriptTarget.ES6) && (this._options.module !== ModuleKind.ES6))
        ...
        if (this._options.targetLib) {
            ...
            this.options.targetLib = this.getEnum(this._options.targetLib, ScriptTarget, ScriptTarget.ES6);
        }
    ...
    CompilerHost.prototype.getDefaultLibFilePaths = function () {
        ...
        else if (this._options.targetLib === ScriptTarget.ES6)
...
function translate(load) {
    ...
    return factory.then(function (_a) {
        ...
        if (isTypescriptDeclaration(load.address)) {
            if (loader.builder && (host.options.module == ModuleKind.ES6)) {
                load.source = null;
            ...
            else if (host.options.module === ModuleKind.ES6)
                load.metadata.format = 'esm';
...
function validateOptions(options) {
    if ((options.module != ModuleKind.System) && (options.module != ModuleKind.ES6)) {
