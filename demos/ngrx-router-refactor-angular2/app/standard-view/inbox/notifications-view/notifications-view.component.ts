...
@Component({
	...
	selector: "bn-notifications-view",
...
export class NotificationsViewComponent implements OnInit, OnDestroy {
	...
	// I view the given conversation via query-string navigation.
	public viewNotification( conversationId: number ) : void {

		this.routerUtils.gotoQueryParam( "inboxConversationId", conversationId );
