...
@Component({
	...
	styleUrls: [ "./enterprise-demo-view.component.less" ],
	templateUrl: "./enterprise-demo-view.component.htm"
})
export class EnterpriseDemoViewComponent implements OnInit, OnDestroy {
