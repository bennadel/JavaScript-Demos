...
@Component({
	...
	styleUrls: [ "./board-members-view.component.less" ],
	templateUrl: "./board-members-view.component.htm"
})
export class BoardMembersViewComponent implements OnInit, OnDestroy {
