...
module.exports = ( env, argv ) => {
	...
	return({
		...
		plugins: [
			...
			// This generates a second CFM file for the COLDFUSION-SPECIFIC context.
			// This is only needed for this specific demo; this is not a usual case.
			new HtmlWebpackPlugin({
				filename: "../index.cfm",
				template: "./app/main.cfm",
				chunksSortMode: "none"
			}),
