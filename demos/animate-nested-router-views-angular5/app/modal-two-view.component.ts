...
@Component({
			...
			[
				transition(
					...
					[
						...
						// Animate the content container in from the right.
						// --
	...
	styleUrls: [ "./modal-two-view.component.less" ],
	template:
	`
		<div class="content">
			<h2>
			...
			<p>
				Wow, this is a nice modal window!
			</p>

			<p>
				<a routerLink="/app/modal/one">Goto modal One</a>
			</p>
...
export class ModalTwoViewComponent {
	// ...
}
