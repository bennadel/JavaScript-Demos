  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse', '$browser',
    ...
    Scope.prototype = {
      ...
      $new: function(isolate, parent) {
        ...
        // When the scope is created, we are going to consider it dirty since it 
        // has not yet had a chance to synchronize with a View. This is needed for
        // directives that add new scopes as part of the $watch() bindings, ex: ngRepeat.
        child.$$stateIsDirty = true;
      ...
      $digest: function() {
        ...
        // Log the fact that we've entered a digest.
        ...
        do { // "while dirty" loop
          ...
          do { // "traverse the scopes" loop
            if (current.$$stateIsDirty && (watchers = current.$$watchers)) {

              // Reset the dirty state since we are now going to be examining the $watch()
              // bindings. At this point, the view will be synchronized with the state.
              current.$$stateIsDirty = false;

              // Log the fact that we are taking the time to look at watchers.
              console.log( "$$watchers examined." );
