  ...
  this.$get = [
    ...
    function compileNodes(nodeList, transcludeFn, $rootElement, maxPriority, ignoreDirective,
      ...
      for (var i = 0; i < nodeList.length; i++) {
        ...
        // If we're currently in a UL element, then log out the length of the child-
        // nodes collection. This is to demonstrate that it's a "live" collection that
        // will update as the DOM is mutated.
        if ( 
            ( nodeList[ i ].parentNode.nodeName === "UL" ) &&
            ( nodeList[ i ].nodeName === "LI" )
            ) {

          console.log( "childNodes length:", nodeList.length, nodeList[ i ].innerHTML );
